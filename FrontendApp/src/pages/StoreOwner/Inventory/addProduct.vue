  ...
  <div class="row">
    <div v-show="step==2" class="col-12 row">
      ...
      <p class="text-title text-black col-12">
        <span class="">Variant</span> (press enter/return key after typing a variant i.e. small, red, linen)
      </p>
    ...
    <input class="col-12 hidden" type="file" multiple ref="fileInput0" @change="onImageSelected0" />
    ...
    <div v-show="step==4" class="col-12">
      ...
      <div class="col-12 row items-center">
        <div class="col-11 text-title text-grey-8">Enable Cash on Delivery?</div>
      ...
      <div class="col-12 row items-center">
        <div class="col-11 text-title text-grey-8">Enable Gift Wrapping Services?</div>
      ...
      <div class="col-12 row items-center">
        <div class="col-11 text-title text-grey-8">Enable Pick-up Item In Store?</div>
      ...
      <div class="col-12 row items-center">
        <div class="col-11 text-title text-grey-8">Enable Delivery Services?</div>
      ...
      <div v-if="delivery_services==true" class="col-12 row items-center text-grey-8">
       This item could be delivered within how many days from the date of purchase?
        <q-input
          class="q-ma-sm"
    ...
    <q-dialog v-model="opened" full-height full-width :maximized="$q.screen.lt.md" class="column">
      <q-card style="width: 800px; max-width: 80vw;" class="col-12">
        <q-bar>
          ...
          <q-btn dense flat icon="close" @click="opened=false, toEdit=''" v-close-popup>
    ...
    <q-dialog v-model="opened_address" :maximized="$q.screen.lt.md" class="column">
      <q-card style="width: 400px; max-width: 80vw;" class="col-12">
        <q-bar>
          <q-space />

          <q-btn dense flat icon="close" @click="opened_address=false, toEdit=''" v-close-popup>
            <q-tooltip content-class="bg-white text-primary">Close</q-tooltip>
          </q-btn>
        </q-bar>
        <q-card-section>
