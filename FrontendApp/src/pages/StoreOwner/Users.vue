<template>
  <div>
    ...
    <br />
    <q-table :data="data" :columns="columns" :filter="filter" row-key="name" flat bordered>
      ...
      <q-tr slot="body" slot-scope="props" :props="props">
        ...
        <q-td key="user_type" :props="props">{{props.row.store_account_type}}</q-td>
        <q-td key="access" :props="props">
          <q-toggle
            ...
            color="primary"
          />
          <ActivateUser v-if="props.row.user_type!='Owner' && props.row.verified!=true" />
        </q-td>
        <q-td key="actions" :props="props">
          <div class="row">
            <ViewUser :data="props.row" class="col-6" />
            <EditUser :data="props.row" class="col-6" />
          </div>
        </q-td>
      </q-tr>
    </q-table>
    <q-page-sticky position="bottom-right" :offset="[30, 30]" style="z-index:999"></q-page-sticky>
  </div>
</template>
