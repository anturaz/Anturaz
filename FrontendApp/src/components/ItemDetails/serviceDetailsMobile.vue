    ...
    <q-item class="q-pa-none q-pr-none">
      ...
      <q-item-section>
        ...
        <q-item-label caption lines="2">
          <span class="text-weight-bold">Date of Needed:</span>
          {{ $formatDate_DateOnly(order.date_needed) }}
        </q-item-label>
        <q-item-label caption lines="2">
          <span class="text-weight-bold">Time of Needed:</span>
          {{ formattedTime }}
        </q-item-label>
            ...
            <q-item-section v-if="breakdown.amount !== 0">
              <q-item-label caption lines="2">
                <span class="text-weight-bold">
                  {{
                    breakdown.description == "Fuel/Transportation Fee"
                      ? "Fuel Fee"
  ...
  computed: {
    ...
    sortedOrders() {
      return [...this.order].sort(
        (a, b) => new Date(a.date_needed) - new Date(b.date_needed)
      );
    },
    formattedTime() {
