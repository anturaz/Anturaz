<template>
  <div>
    <q-layout class="bg-image" view="lHh Lpr lFf">
      <div
        class=" q-gutter-md row items-center justify-center bg-black"
        v-if="!$q.screen.lt.md"
      >
        <q-bar
          ...
          <div class="row inline">
            <q-item clickable class="social-icons">
              <q-item-section>
                ...
                <q-icon class="text-white" name="music_note"> </q-icon>
              </q-item-section>
            </q-item>
            <q-item clickable class="social-icons">
              <q-item-section>
                <q-icon class="text-white" name="fab fa-youtube"> </q-icon>
              </q-item-section>
            </q-item>
            <q-item clickable class="social-icons">
              <q-item-section>
                <q-icon class="text-white" name="fab fa-twitter"> </q-icon>
              </q-item-section>
            </q-item>
            <q-item clickable class="social-icons">
              <q-item-section>
                <q-icon class="text-white" name="fab fa-instagram"> </q-icon>
              </q-item-section>
            </q-item>
            <q-item clickable class="social-icons">
              <q-item-section>
                <!-- <i class="fa-brands fa-facebook-square"></i> -->
                <q-icon class="text-white" name="fab fa-facebook"> </q-icon>
              </q-item-section>
            </q-item>
            <!-- <q-item clickable class="social-icons">
                <q-item-section>
