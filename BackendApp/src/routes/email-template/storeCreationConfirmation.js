                                                                            ...
                                                                            <tr>
                                                                               <td
                                                                                  ...
                                                                                  <div
                                                                                     ...
                                                                                     Hello!
                                                                                     <div><br></div>
                                                                                     <div>Congratulation! You have started your own store with us!</div>
                                                                                     <div><br></div>
                                                                                     <div><b>Store Name:&nbsp;</b>` + result.data[0].shop_name + `</div>
                                                                  
                                                                                     <div><br></div>
                                                                                     <div>To login, kindly click this link:&nbsp;<a href="` + appLink + `StoreOwner/Login" style="background-color: transparent;">http://enturaz.us-east-1.elasticbeanstalk.com/#/StoreOwner/login</a></div>
                                                                                     <div><br></div>
                                                                                  </div>
                                                                               </td>
                                                                            </tr>
