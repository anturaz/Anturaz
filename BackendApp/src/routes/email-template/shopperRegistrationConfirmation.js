module.exports = function(appLink, result) {
    ...
    <div
       ...
       <div><br></div>
       <div>Welcome to Enturaz, the number one event marketplace in the country with over 1,000 suppliers nationwide! Please click on the link below to login and start shopping! </div>
       <br>
       <a href="` + appLink + `ShopperLogin">` + appLink + `ShopperLogin</a>
       </div>
 </td>
 `
    return `<!doctype html>
