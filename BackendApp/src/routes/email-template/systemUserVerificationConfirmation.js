module.exports = function(appLink, result) {
    ...
    <div
       ...
       <div><br></div>
       <div>Congratulations! You have been verified as ` + result.data[0].position + ` of the Enturaz system.</div>
       <div>You may now login to the Admin System.</div>
       <ul>
       <li>Click this link and it will redirect you to the login page: <a href="` + appLink + `Admin/Login">` + appLink + `Admin/Login</a></li>
